...
import { Audience, YoutubeContent, Calendar, TwitchContent, Stacked, Customers, Kanban, Line, Area, Bar, Pie, Financial, ColorPicker, ColorMapping, Editor } from '../';
...
async function getUserProfilePicture(stream, twitchAccessTokenData) {
    ...
    return twitchUserDataResponse.data[0].profile_image_url
}
