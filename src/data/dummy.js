...
import { AiOutlineStock, AiOutlineCheckSquare } from 'react-icons/ai';
import { FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { FaYoutube, FaTwitch} from 'react-icons/fa'
import { BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsPeopleFill, BsFillPersonFill, BsGenderMale, BsCalendar4Week } from 'react-icons/bs';
import { BiBrain } from 'react-icons/bi';
import { RiCompassDiscoverFill } from 'react-icons/ri';
import { MdOutlineSupervisorAccount } from 'react-icons/md';
import { HiOutlineRefresh, HiOutlineNewspaper } from 'react-icons/hi';
...
const gridEmployeeProfile = (props) => (
  <div className="flex items-center gap-2">
    <Image
      ...
      src={props.StreamerPFP}
      alt="employee"
      width={300}
      height={300}
    />
    <a target="_blank" href={props.StreamLink} rel="noopener noreferrer" className='text-sunset-orange font-oxanium-semibold uppercase'>{props.Streamer}</a>
  </div>
);

const gridEmployeeCountry = (props) => (
  <div className="flex items-center justify-center gap-2">
    <span>{DateTime.fromISO(props.StartedAt).toLocaleString(DateTime.DATETIME_MED)}</span>
  </div>
);

const gridCountryFlag = (props) => (
  <div className="flex items-center justify-center gap-2">
    <ReactCountryFlag countryCode={props.Country == "en" ? "US" : props.Country == "zh" ? "CN" : props.Country == "uk" ? "GB" : props.Country} style={{fontSize: '2em', paddingRight: '10px'}} />
  </div>
);

const gridStreamLink = (props) => (
  <div className="flex items-center justify-center gap-2">
    <a target="_blank" rel="noopener noreferrer" href={props.StreamLink}>{props.StreamLink}</a>
  </div>
);
...
export const employeesGrid = [
  ...
  { field: 'CurrentViewers',
    type: 'number',
    headerText: 'Current Viewers',
    width: '135',
    textAlign: 'Center' },
  ...
  { field: 'Country',
    ...
    width: '120',
    textAlign: 'Center',
    template: gridCountryFlag },

  { field: 'StreamLink',
    headerText: 'Link',
    width: '125',
    textAlign: 'Center',
    template: gridStreamLink },
];
...
export const employeesData = [
  {
    StreamLink: 1,
    Streamer: 'Nancy Davolio',
    StreamName: 'Sales Representative',
    CurrentViewers: '01/02/2021',
    StartedAt: 'USA',
    Language: 'Carson',
    StreamerPFP:
    avatar3,
  ...
  {
    StreamLink: 2,
    Streamer: 'Nasimiyu Danai',
    StreamName: 'Marketing Head',
    CurrentViewers: '01/02/2021',
    StartedAt: 'USA',
    Language: 'Carson',
    StreamerPFP:
