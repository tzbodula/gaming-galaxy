      ...
      <div className="absolute top-0 left-0">
        ...
        <Fade triggerOnce cascade>
          ...
          <div className="mx-auto z-10 bg-nightsky/70 w-3/4">
            ...
            <b className="inline-block text-[3.4rem]  min-w-full  italic text-center ">
              THE NEXT GENERATION
            </b>
            <b className="inline-block text-[3.4rem]  min-w-full  -mt-4 italic text-center ">
              OF GAMING CREATORS
            </b>
            <div className={`transition-all inline-block  text-[8.4rem] ${state == "success" ? "text-green-400" : state == "error" ? "text-red-600" : `text-${color}`} font-extrabold  -mt-8 min-w-full  text-center italic `}>
              ARE HERE
            </div>
            <b className="inline-block text-[2.8rem]  -mt-6 min-w-full  italic text-center">
