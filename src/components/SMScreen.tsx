      ...
      <div className="absolute top-0 left-0">
        ...
        <Fade triggerOnce cascade>
          ...
          <div className="mx-auto z-10 bg-nightsky/70 w-3/4">
            ...
            <div className={`transition-all inline-block  text-[4.7rem] ${state == "success" ? "text-green-400" : state == "error" ? "text-red-600" : `text-${color}`} font-extrabold  -mt-4 min-w-full  text-center italic `}>
              ARE HERE
            </div>
