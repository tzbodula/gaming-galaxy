      ...
      <div className="absolute top-0 left-0">
        ...
        <Fade triggerOnce cascade>
          ...
          <div className="mx-auto z-10 bg-nightsky/70 w-3/4">
            ...
            <div className={`font-oxanium-extrabold transition-all inline-block  text-[4.7rem] ${state == "success" ? "text-green-400" : state == "error" ? "text-red-600" : `text-${color}`} font-extrabold  -mt-4 min-w-full  text-center italic `}>
              ARE HERE
            </div>
        ...
        <div className={`mt-4 mx-auto rounded-lg box-border w-3/4 h-fit border-[2px] border-solid border-${state == "success" ? "border-green-400" : state == "error" ? "border-red-600" : `border-${color}`} bg-nightsky/70`}>
              <h1 className="font-oxanium-extrabold italic uppercase mt-2 text-[2.2rem]">{title}</h1>
              <h1 className={`transition-all font-oxanium-bold italic uppercase text-[2.2rem] -mt-4 ${state == "success" ? "text-green-400" : state == "error" ? "text-red-600" : `text-${color}`}`}>{subtitle}</h1>
            </div>
            </Fade>
      </div>
